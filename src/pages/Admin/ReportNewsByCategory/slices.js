export const GET_REPORT_NEWS = 'admin/ReportNewsByCategory/getReportNews'
export const GET_REPORT_NEWS_SUCCESS = 'admin/ReportNewsByCategory/getReportNewsSuccess'
export const GET_REPORT_NEWS_FAILURE = 'admin/ReportNewsByCategory/getReportNewsFailure'
